...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_default(
    KC__MUTE, KC__VOLUP, TO(2),
    KC_MEDIA_PREV_TRACK, KC__VOLDOWN, KC_MEDIA_NEXT_TRACK
  ),
  [2] = LAYOUT_default(
    KC__MUTE, KC_UP, TO(3),
...
bool oled_task_user(void) {
    ...
    switch (get_highest_layer(layer_state)) {
      case 0:
        oled_write("Warstwa 1", false);
        break;
      case 1:
        oled_write("Warstwa 2", false);
        break;
      case 2:
        oled_write("Warstwa 3", false);
        break;
      case 3:
        oled_write("Warstwa 4", false);
        break;
      default:
